...
<DIV><LABEL for=login_username><STRONG>用户名：</STRONG></LABEL> <INPUT 
id="login_username" class="field required" title="请输入您的用户名" name="login_username"> </DIV>
<DIV><LABEL for=login_password><STRONG>密码：</STRONG></LABEL> <INPUT 
id="login_password" class="field required" title="密码不能为空" name="login_password" 
type="password"> </DIV>
